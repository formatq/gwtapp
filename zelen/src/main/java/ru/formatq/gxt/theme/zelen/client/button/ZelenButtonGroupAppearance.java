...
public class ZelenButtonGroupAppearance extends ButtonGroupBaseAppearance {

  public interface ZelenButtonGroupTableFrameResources extends ButtonGroupBaseTableFrameResources {
  ...
  public interface ZelenButtonGroupResources extends ButtonGroupResources {
    @Source({"com/sencha/gxt/theme/base/client/button/ButtonGroup.css", "ZelenButtonGroup.css"})
    ButtonGroupStyle css();
  }

  public ZelenButtonGroupAppearance() {
    this(GWT.<ZelenButtonGroupResources> create(ZelenButtonGroupResources.class));
  }

  public ZelenButtonGroupAppearance(ZelenButtonGroupResources resources) {
    super(resources, GWT.<GroupTemplate> create(GroupTemplate.class), new TableFrame(
        GWT.<ZelenButtonGroupTableFrameResources> create(ZelenButtonGroupTableFrameResources.class)));
  }
