 ...
 */
package ru.formatq.gxt.theme.zelen.client.tools;
...
public class ZelenTools extends Tools {

  public interface ZelenToolResources extends ToolResources, ClientBundle {
  ...
  public ZelenTools() {
    super(GWT.<ToolResources> create(ZelenToolResources.class));
  }
