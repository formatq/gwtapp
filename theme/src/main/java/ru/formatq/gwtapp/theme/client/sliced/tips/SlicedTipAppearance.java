 ...
 */
package ru.formatq.gwtapp.theme.client.sliced.tips;
...
public class SlicedTipAppearance extends TipDefaultAppearance {
  ...
  public interface SlicedTipResources extends TipResources {
    ...
    @Override
    @Source("ru/formatq/gwtapp/theme/client/base/tips/anchorBottom.png")
    ImageResource anchorBottom();

    @Override
    @Source("ru/formatq/gwtapp/theme/client/base/tips/anchorLeft.png")
    ImageResource anchorLeft();

    @Override
    @Source("ru/formatq/gwtapp/theme/client/base/tips/anchorRight.png")
    ImageResource anchorRight();

    @Override
    @Source("ru/formatq/gwtapp/theme/client/base/tips/anchorTop.png")
