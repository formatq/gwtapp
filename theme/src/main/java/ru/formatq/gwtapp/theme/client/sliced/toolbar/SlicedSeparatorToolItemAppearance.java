...
import ru.formatq.gwtapp.theme.client.base.toolbar.Css3SeparatorToolItemAppearance;
...
public class SlicedSeparatorToolItemAppearance extends Css3SeparatorToolItemAppearance {
  ...
  public interface SlicedSeparatorToolItemResources extends Css3SeparatorToolItemResources {
    ...
    @Source({"ru/formatq/gwtapp/theme/client/base/toolbar/Css3SeparatorToolItem.css", "SlicedSeparatorToolItem.css"})
    @Override
