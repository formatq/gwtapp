 ...
 */
package ru.formatq.gwtapp.theme.client.sliced.tabs;
...
public class SlicedTabPanelAppearance implements TabPanelAppearance {
  ...
  public interface SlicedTabPanelResources extends ClientBundle {
    ...
    @Source("ru/formatq/gwtapp/theme/client/base/tabs/scrollerLeft.png")
    ImageResource scrollerLeftArrow();

    @Source("ru/formatq/gwtapp/theme/client/base/tabs/scrollerRight.png")
    ImageResource scrollerRightArrow();

    @Source("ru/formatq/gwtapp/theme/client/base/tabs/tabClose.png")
