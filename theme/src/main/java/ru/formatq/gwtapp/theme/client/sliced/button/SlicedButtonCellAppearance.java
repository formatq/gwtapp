 ...
 */
package ru.formatq.gwtapp.theme.client.sliced.button;
...
public class SlicedButtonCellAppearance<C> extends ButtonCellDefaultAppearance<C> {
  ...
  public interface SlicedButtonCellResources extends ButtonCellResources {
    ...
    @Source("ru/formatq/gwtapp/theme/client/base/button/arrow.png")
    ImageResource arrow();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/arrowBottom.png")
    ImageResource arrowBottom();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/split.png")
    ImageResource split();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/splitBottom.png")
    ImageResource splitBottom();


    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/toolBarArrow.png")
    ImageResource toolBarArrow();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/toolBarArrowBottom.png")
    ImageResource toolBarArrowBottom();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/toolBarButtonSplit.png")
    ImageResource toolBarSplit();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("ru/formatq/gwtapp/theme/client/base/button/toolBarButtonSplitBottom.png")
