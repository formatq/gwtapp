 ...
 */
package ru.formatq.gwtapp.theme.greeny.client.sliced.tabs;
...
public class SlicedTabPanelAppearance implements TabPanelAppearance {
  ...
  public interface SlicedTabPanelResources extends ClientBundle {
    ...
    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tabs/scrollerLeft.png")
    ImageResource scrollerLeftArrow();

    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tabs/scrollerRight.png")
    ImageResource scrollerRightArrow();

    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tabs/tabClose.png")
