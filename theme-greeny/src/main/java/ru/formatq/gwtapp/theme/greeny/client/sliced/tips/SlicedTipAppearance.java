 ...
 */
package ru.formatq.gwtapp.theme.greeny.client.sliced.tips;
...
public class SlicedTipAppearance extends TipDefaultAppearance {
  ...
  public interface SlicedTipResources extends TipResources {
    ...
    @Override
    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tips/anchorBottom.png")
    ImageResource anchorBottom();

    @Override
    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tips/anchorLeft.png")
    ImageResource anchorLeft();

    @Override
    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tips/anchorRight.png")
    ImageResource anchorRight();

    @Override
    @Source("ru/formatq/gwtapp/theme/greeny/client/base/tips/anchorTop.png")
